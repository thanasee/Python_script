...
def usage():
    ...
    print("""
Usage: vaspConvert.py <input> <output>

This script converts VASP's input structure file to VASP5 Structure file format.
...
def write_POSCAR(filepath, lattice_matrix, elements, atom_counts, positions_cartesian,
    ...
    with open(filepath, 'w') as o:
        o.write("Generated by vaspConvert.py\n")
        o.write(f"   {1.0:.14f}\n")
...
def main():
    ...
    print(f"\nDetected {'Direct' if unformat['is_direct'] else 'Cartesian'} coordinates -> "
          f"Converting to {'Cartesian' if unformat['is_direct'] else 'Direct'} coordinates.\n")
